...
<head>
    ...
    <title>{{ config('app.name', 'SMK Peristek Pangkah') }}</title>
    ...
    height: 100%;
    width: 100%;
    overflow: auto; /* Menghindari scroll bar */
...
.full-screen-image {
    ...
    top: 0;
    left: 0;
    width: 100vw; /* Menutupi lebar viewport */
    height: 100vh; /* Menutupi tinggi viewport */
    object-fit: cover; /* Menjaga rasio aspek dan menutupi seluruh elemen */
...
<body  >
<div class="bg1 position-absolute">
    <img src="{{url('/img/peristek.jpeg') }}" alt="Full Screen Image" class="full-screen-image">
    </div>
    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light  navbar-laravel" style="background-color: #e3f2fd;">
            ...
            <img src="{{url('/img/LOGO29.png') }}" width="50px" alt="Gambar">
           <figcaption class="p-2">SMK Peristek Pangkah</figcaption>
</a>
